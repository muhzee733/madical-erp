                            ...
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 pt-4">
                                    <div className="mb-5 text-white-50">
                                        <h1 className="display-5 coming-soon-text">Unauthorized User</h1>
                                        <p className="fs-14">Please login again or contact admin. </p>
                                        <div className="mt-4 pt-2">
                                            <Link to="/login" className="btn btn-success"><i className="mdi mdi-home me-1"></i> Login</Link>
                                        </div>
                                    </div>
